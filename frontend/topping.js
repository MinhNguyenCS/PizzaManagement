...
$(document).ready(function () {
    ...
    $("#updateToppingForm").submit(function (event) {
        ...
        $.ajax({
            url: `https://akatsukipizza.uk/pizza/api/topping/update`,
            method: "POST",
    ...
    $(document).on("click", "#delete_topping", function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: `https://akatsukipizza.uk/pizza/api/topping/delete/${toppingId}`,
                    method: "POST",
                    success: function (response) {
 ...
 $(document).ready(function () {
    $("#toppingForm").submit(function (event) {
        ...
        $.ajax({
            url: "https://akatsukipizza.uk/pizza/api/topping/adding",
            method: "POST",
